    ...
    // PACKAGES
    app.MapGet("/packages", Packages.Get);   //was this before: app.MapGet("/packages", (Config config) => Packages.Get(0, config)); whoever made this, if you still want it as before seek to fix it. thanks :) //oskar
